...
# - but imo its much better to do things dynamically from the start, then minor ui changes are unlikely to affect the functionality a lot if at all
# - plus likelihood of the functionality being compatible with a large array of different device sizes is drastically increased
