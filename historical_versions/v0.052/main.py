...
# note to ensure displaying/logging things somewhere and properly
# - tbf this is first version, for sure will refactor and improve so tbf dont be long as is better to get the functionality out quicker 
# make a few ongoing recordings
# consider pyqt5
